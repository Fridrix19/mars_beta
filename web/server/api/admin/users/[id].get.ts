...
export default defineEventHandler(async (e) => {
  ...
  const u = await one(`select id, email, name, phone, status, kyc_status, kyc_reason, consent_offer, consent_news, created_at, last_login_at, failed_logins, locked_until,
